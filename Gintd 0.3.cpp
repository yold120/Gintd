...
///////////////////////////////////////////////SERVICIOS
	...
	while(!Lec.eof() && !encontrado)
	{
		...
		Lec>>serv>>tserv>>descripcionserv>>preciomin>>preciomax;  


		if (tserv == mserv)
		{
			cout<<"Codigo---------:"<<serv<<s;
			cout<<"Producto-------:"<<tserv<<s;
			cout<<"Categoria------:"<<descripcion<<s;
			cout<<"Precio Venta---:"<<preciomin<<s;
			cout<<"Precion Compra-:"<<preciomax<<s;
			encontrado = true;
		}
